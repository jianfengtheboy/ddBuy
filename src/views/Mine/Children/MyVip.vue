 ...
 * @Date: 2020-02-23 16:50:05
 * @LastEditTime: 2020-03-01 13:35:34
 * @Description: 我的绿卡
 -->
<template>
  <div id="myVip" ref="myVip">
    <div v-if="!isShowLoading">
      ...
      <div class="vipPrivilege">
        ...
        <div class="becomVipBtn" @click="goToPayPage">
          {{$t('mine.fiftypecert')}}
        </div>
      </div>
      <!-- 第1部分 -->
      ...
      <div class="coupons">
        ...
        <div class="integralToFast" @click="goToPayPage">
          {{$t('mine.cardSpecialTip')}}
        </div>
      </div>
      <!-- 第3部分 -->
      <div class="coupons">
    ...
    <transition name="fade">
      <div class="bottomJoinVip"
        ...
        <div class="bottomDesc">
          <span class="yearCart">{{$t('mine.yearCard')}}</span>
