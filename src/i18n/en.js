export default {
  ...
  goodsDetail: {
    ...
    sold: 'sold',
    goodsTips: 'This commodity is priced at 500g/ piece. If the price is less than 500g, the price difference will be refunded',
  ...
  mine: {
    ...
    recomend: 'Open a green card to enjoy three benefits, is expected to save 6.66 yuan per single',
  ...
  login: {
    ...
    qqchant: 'QQ login',
    tipTile: 'Warm Prompt',
    tipContent: 'Unregistered mobile phone number will be automatically registered when logging in and will represent consent',
    tip: 'User agreement',
